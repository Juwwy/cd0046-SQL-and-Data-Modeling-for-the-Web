...
# shows_tables = db.Table('shows_tables',

#       db.Column('artist_id', db.Integer, db.ForeignKey('artists.id'), primary_key=True),
#       db.Column('venue_id', db.Integer, db.ForeignKey('venues.id'), primary_key=True),
#       db.Column('start_time', db.DateTime(timezone=True), nullable=False, default=datetime.utcnow() )
...
def search_venues():
  ...
  searchVal = form.request.form['search_term'].lower()
  # Artist.query.filter(Artist.name=='Juwon Olowu').all()

  searchResult = Venue.query.filter(Venue.name.like(f'%{searchVal}%')).all()
...
def create_venue_submission():
  ...
  try:
      ...
      names= form.request.form['name'].lower()
      city= form.request.form['city'].lower()
      state= form.request.form['state'].lower()
      phone= form.request.form['phone'].lower()
      addr = form.request.form['address'].lower()
      genres= form.request.form['genres'].lower()
      facebook_link= form.request.form['facebook_link'].lower()
      image_link = form.request.form['image_link'].lower()
      website= form.request.form['website_link'].lower()
      talent= False  #['seeking_talent']
      desc= form.request.form['seeking_description'].lower()
...
def search_artists():
  ...
  searchResult = Artist.query.filter(Artist.name.like(f'%{searchVal}%')).all()
...
def edit_artist_submission(artist_id):
  ...
  a1 = form.request.form['name'].lower()
  a2 = form.request.form['city'].lower()
  a3 = form.request.form['state'].lower()
  a4 = form.request.form['phone'].lower()
  a6 = form.request.form['genres'].lower()
  a7 = form.request.form['facebook_link'].lower()
  a8 = form.request.form['image_link'].lower()
  a9 = form.request.form['website_link'].lower()
  a10 = False
  a11 = form.request.form['seeking_description'].lower()
...
def edit_venue(venue_id):
  ...
  #request.args.form['name'] = result.name
  # form.city = result.city
  # form.state = result.state
  # form.phone = result.phone
  # form.genres = result.genres
  # form.facebook_link = result.facebook_link
  # form.image_link = result.image_link
  # form.website_link = result.website
  # form.seeking_venue = result.looking_talent
...
def edit_venue_submission(venue_id):
  ...
  v1 = form.request.form['name'].lower()
  v2 = form.request.form['city'].lower()
  v3 = form.request.form['state'].lower()
  v4 = form.request.form['phone'].lower()
  v5 = form.request.form['address'].lower()
  v6 = form.request.form['genres'].lower()
  v7 = form.request.form['facebook_link'].lower()
  v8 = form.request.form['image_link'].lower()
  v9 = form.request.form['website_link'].lower()
  v10 = False
  v11 = form.request.form['seeking_description'].lower()
...
def delete_artist(artist_id):
  ...
  try:
    ...
    db.session.query(Artist).get(artist_id).delete()
    db.session.commit()
  except:
    db.session.rollback()
  finally:
  ...
  #redirect(url_for('pages/home.html'))
